...
import com.patrick.inventorymanagementtask.api.models.ApiExpenseReq;
...
public class ApiExpensesController extends ApiAbstractController {
    @Autowired
    ...
    @GetMapping("/all")
    public ResponseModel expenses(@RequestHeader("Authorization") String authHeader,
        ...
        try {
            response = apiShopService.myExpenses(shopId,page,size,httpServletRequest );
    ...
    @PostMapping( "/create")
    public ResponseModel createExpense(@RequestHeader("Authorization") String authHeader, @RequestBody ApiExpenseReq request, HttpServletRequest httpServletRequest ) {
        ResponseModel response;
        try {
            response =apiShopService.addExpense(request, httpServletRequest);
            response.setRefreshedToken(refreshedToken(authHeader));
        } catch (Exception e) {
    ...
    protected ResponseModel apiLogger(String url, JsonNode request, ResponseModel response) {
        return super.apiLogger("/api/v1/expense" + url, filterRequest(request, ""), response);
    }
    ...
    protected ResponseModel apiError(String url, JsonNode request, Exception ex) {
        return super.apiError("/api/v1/expense" + url, filterRequest(request, ""), ex);
    }
}
